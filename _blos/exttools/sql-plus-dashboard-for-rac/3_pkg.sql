...
begin
 ---extending arrays
    pa1.extend(17);   pa2.extend(17);  pa3.extend(17);  pa4.extend(17);  pa5.extend(17);
    pa6.extend(17);   pa7.extend(17);  pa8.extend(17);  pa9.extend(17);  pa10.extend(17);
    pa11.extend(17);  pa12.extend(17); pa13.extend(17); pa14.extend(17); pa15.extend(17);
    pa16.extend(17); pa17.extend(17); pa18.extend(17); pa19.extend(17); pa20.extend(17);
    pa21.extend(17); pa22.extend(17); pa23.extend(17); pa24.extend(17); pa25.extend(17);
    pa26.extend(17); pa27.extend(17); pa28.extend(17); pa29.extend(17); pa30.extend(17);
    pa31.extend(17); pa32.extend(17); pa33.extend(17); pa34.extend(17); pa35.extend(17);
    pa36.extend(17); pa37.extend(17); pa38.extend(17); pa39.extend(17); pa40.extend(17);
    pa41.extend(17); pa42.extend(17); pa43.extend(17); pa44.extend(17); pa45.extend(17);
    pa46.extend(17); pa47.extend(17); pa48.extend(17); pa49.extend(17); pa50.extend(17);
    pa51.extend(17); pa52.extend(17); pa53.extend(17); pa54.extend(17); pa55.extend(17);
    pa56.extend(17); pa57.extend(17); pa58.extend(17); pa59.extend(17); pa60.extend(17);
    pa61.extend(17); pa62.extend(17); pa63.extend(17); pa64.extend(17); pa65.extend(17);
    pa66.extend(17); pa67.extend(17); pa68.extend(17); pa69.extend(17); pa70.extend(17);
    pa71.extend(17); pa72.extend(17); pa73.extend(17); pa74.extend(17); pa75.extend(17);
    pa76.extend(17); pa77.extend(17); pa78.extend(17); pa79.extend(17); pa80.extend(17);
exception
when others then
...
pa10:= pa9; pa9:=pa8; pa8 :=pa7; pa7:=pa6; pa6:=pa5; pa5:=pa4; pa4:=pa3; pa3:=pa2; pa2:=pa1;
    ...
    -- updating first array
       ...
       pa1(16) := ty_obj(pv_maxsess);
          ...
          --- rebuilding all arrays
              for i in 1..15 loop
                   if to_number(pa1(16).output)  >= to_number(pa_stet(i).output) then pa1(i) := ty_obj(v_val); else pa1(i) := ty_obj(' '); end if;
                   if to_number(pa2(16).output)  >= to_number(pa_stet(i).output) then pa2(i) := ty_obj(v_val); else pa2(i) := ty_obj(' '); end if;
                   if to_number(pa3(16).output)  >= to_number(pa_stet(i).output) then pa3(i) := ty_obj(v_val); else pa3(i) := ty_obj(' '); end if;
                   if to_number(pa4(16).output)  >= to_number(pa_stet(i).output) then pa4(i) := ty_obj(v_val); else pa4(i) := ty_obj(' '); end if;
                   if to_number(pa5(16).output)  >= to_number(pa_stet(i).output) then pa5(i) := ty_obj(v_val); else pa5(i) := ty_obj(' '); end if;
                   if to_number(pa6(16).output)  >= to_number(pa_stet(i).output) then pa6(i) := ty_obj(v_val); else pa6(i) := ty_obj(' '); end if;
                   if to_number(pa7(16).output)  >= to_number(pa_stet(i).output) then pa7(i) := ty_obj(v_val); else pa7(i) := ty_obj(' '); end if;
                   if to_number(pa8(16).output)  >= to_number(pa_stet(i).output) then pa8(i) := ty_obj(v_val); else pa8(i) := ty_obj(' '); end if;
                   if to_number(pa9(16).output)  >= to_number(pa_stet(i).output) then pa9(i) := ty_obj(v_val); else pa9(i) := ty_obj(' '); end if;
                   if to_number(pa10(16).output)  >= to_number(pa_stet(i).output) then pa10(i) := ty_obj(v_val); else pa10(i) := ty_obj(' '); end if;
                   if to_number(pa11(16).output)  >= to_number(pa_stet(i).output) then pa11(i) := ty_obj(v_val); else pa11(i) := ty_obj(' '); end if;
                   if to_number(pa12(16).output)  >= to_number(pa_stet(i).output) then pa12(i) := ty_obj(v_val); else pa12(i) := ty_obj(' '); end if;
                   if to_number(pa13(16).output)  >= to_number(pa_stet(i).output) then pa13(i) := ty_obj(v_val); else pa13(i) := ty_obj(' '); end if;
                   if to_number(pa14(16).output)  >= to_number(pa_stet(i).output) then pa14(i) := ty_obj(v_val); else pa14(i) := ty_obj(' '); end if;
                   if to_number(pa15(16).output)  >= to_number(pa_stet(i).output) then pa15(i) := ty_obj(v_val); else pa15(i) := ty_obj(' '); end if;
                   if to_number(pa16(16).output)  >= to_number(pa_stet(i).output) then pa16(i) := ty_obj(v_val); else pa16(i) := ty_obj(' '); end if;
                   if to_number(pa17(16).output)  >= to_number(pa_stet(i).output) then pa17(i) := ty_obj(v_val); else pa17(i) := ty_obj(' '); end if;
                   if to_number(pa18(16).output)  >= to_number(pa_stet(i).output) then pa18(i) := ty_obj(v_val); else pa18(i) := ty_obj(' '); end if;
                   if to_number(pa19(16).output)  >= to_number(pa_stet(i).output) then pa19(i) := ty_obj(v_val); else pa19(i) := ty_obj(' '); end if;
                   if to_number(pa20(16).output)  >= to_number(pa_stet(i).output) then pa20(i) := ty_obj(v_val); else pa20(i) := ty_obj(' '); end if;
                   if to_number(pa21(16).output)  >= to_number(pa_stet(i).output) then pa21(i) := ty_obj(v_val); else pa21(i) := ty_obj(' '); end if;
                   if to_number(pa22(16).output)  >= to_number(pa_stet(i).output) then pa22(i) := ty_obj(v_val); else pa22(i) := ty_obj(' '); end if;
                   if to_number(pa23(16).output)  >= to_number(pa_stet(i).output) then pa23(i) := ty_obj(v_val); else pa23(i) := ty_obj(' '); end if;
                   if to_number(pa24(16).output)  >= to_number(pa_stet(i).output) then pa24(i) := ty_obj(v_val); else pa24(i) := ty_obj(' '); end if;
                   if to_number(pa25(16).output)  >= to_number(pa_stet(i).output) then pa25(i) := ty_obj(v_val); else pa25(i) := ty_obj(' '); end if;
                   if to_number(pa26(16).output)  >= to_number(pa_stet(i).output) then pa26(i) := ty_obj(v_val); else pa26(i) := ty_obj(' '); end if;
                   if to_number(pa27(16).output)  >= to_number(pa_stet(i).output) then pa27(i) := ty_obj(v_val); else pa27(i) := ty_obj(' '); end if;
                   if to_number(pa28(16).output)  >= to_number(pa_stet(i).output) then pa28(i) := ty_obj(v_val); else pa28(i) := ty_obj(' '); end if;
                   if to_number(pa29(16).output)  >= to_number(pa_stet(i).output) then pa29(i) := ty_obj(v_val); else pa29(i) := ty_obj(' '); end if;
                   if to_number(pa30(16).output)  >= to_number(pa_stet(i).output) then pa30(i) := ty_obj(v_val); else pa30(i) := ty_obj(' '); end if;
                   if to_number(pa31(16).output)  >= to_number(pa_stet(i).output) then pa31(i) := ty_obj(v_val); else pa31(i) := ty_obj(' '); end if;
                   if to_number(pa32(16).output)  >= to_number(pa_stet(i).output) then pa32(i) := ty_obj(v_val); else pa32(i) := ty_obj(' '); end if;
                   if to_number(pa33(16).output)  >= to_number(pa_stet(i).output) then pa33(i) := ty_obj(v_val); else pa33(i) := ty_obj(' '); end if;
                   if to_number(pa34(16).output)  >= to_number(pa_stet(i).output) then pa34(i) := ty_obj(v_val); else pa34(i) := ty_obj(' '); end if;
                   if to_number(pa35(16).output)  >= to_number(pa_stet(i).output) then pa35(i) := ty_obj(v_val); else pa35(i) := ty_obj(' '); end if;
                   if to_number(pa36(16).output)  >= to_number(pa_stet(i).output) then pa36(i) := ty_obj(v_val); else pa36(i) := ty_obj(' '); end if;
                   if to_number(pa37(16).output)  >= to_number(pa_stet(i).output) then pa37(i) := ty_obj(v_val); else pa37(i) := ty_obj(' '); end if;
                   if to_number(pa38(16).output)  >= to_number(pa_stet(i).output) then pa38(i) := ty_obj(v_val); else pa38(i) := ty_obj(' '); end if;
                   if to_number(pa39(16).output)  >= to_number(pa_stet(i).output) then pa39(i) := ty_obj(v_val); else pa39(i) := ty_obj(' '); end if;
                   if to_number(pa40(16).output)  >= to_number(pa_stet(i).output) then pa40(i) := ty_obj(v_val); else pa40(i) := ty_obj(' '); end if;
                   if to_number(pa41(16).output)  >= to_number(pa_stet(i).output) then pa41(i) := ty_obj(v_val); else pa41(i) := ty_obj(' '); end if;
                   if to_number(pa42(16).output)  >= to_number(pa_stet(i).output) then pa42(i) := ty_obj(v_val); else pa42(i) := ty_obj(' '); end if;
                   if to_number(pa43(16).output)  >= to_number(pa_stet(i).output) then pa43(i) := ty_obj(v_val); else pa43(i) := ty_obj(' '); end if;
                   if to_number(pa44(16).output)  >= to_number(pa_stet(i).output) then pa44(i) := ty_obj(v_val); else pa44(i) := ty_obj(' '); end if;
                   if to_number(pa45(16).output)  >= to_number(pa_stet(i).output) then pa45(i) := ty_obj(v_val); else pa45(i) := ty_obj(' '); end if;
                   if to_number(pa46(16).output)  >= to_number(pa_stet(i).output) then pa46(i) := ty_obj(v_val); else pa46(i) := ty_obj(' '); end if;
                   if to_number(pa47(16).output)  >= to_number(pa_stet(i).output) then pa47(i) := ty_obj(v_val); else pa47(i) := ty_obj(' '); end if;
                   if to_number(pa48(16).output)  >= to_number(pa_stet(i).output) then pa48(i) := ty_obj(v_val); else pa48(i) := ty_obj(' '); end if;
                   if to_number(pa49(16).output)  >= to_number(pa_stet(i).output) then pa49(i) := ty_obj(v_val); else pa49(i) := ty_obj(' '); end if;
                   if to_number(pa50(16).output)  >= to_number(pa_stet(i).output) then pa50(i) := ty_obj(v_val); else pa50(i) := ty_obj(' '); end if;
                   if to_number(pa51(16).output)  >= to_number(pa_stet(i).output) then pa51(i) := ty_obj(v_val); else pa51(i) := ty_obj(' '); end if;
                   if to_number(pa52(16).output)  >= to_number(pa_stet(i).output) then pa52(i) := ty_obj(v_val); else pa52(i) := ty_obj(' '); end if;
                   if to_number(pa53(16).output)  >= to_number(pa_stet(i).output) then pa53(i) := ty_obj(v_val); else pa53(i) := ty_obj(' '); end if;
                   if to_number(pa54(16).output)  >= to_number(pa_stet(i).output) then pa54(i) := ty_obj(v_val); else pa54(i) := ty_obj(' '); end if;
                   if to_number(pa55(16).output)  >= to_number(pa_stet(i).output) then pa55(i) := ty_obj(v_val); else pa55(i) := ty_obj(' '); end if;
                   if to_number(pa56(16).output)  >= to_number(pa_stet(i).output) then pa56(i) := ty_obj(v_val); else pa56(i) := ty_obj(' '); end if;
                   if to_number(pa57(16).output)  >= to_number(pa_stet(i).output) then pa57(i) := ty_obj(v_val); else pa57(i) := ty_obj(' '); end if;
                   if to_number(pa58(16).output)  >= to_number(pa_stet(i).output) then pa58(i) := ty_obj(v_val); else pa58(i) := ty_obj(' '); end if;
                   if to_number(pa59(16).output)  >= to_number(pa_stet(i).output) then pa59(i) := ty_obj(v_val); else pa59(i) := ty_obj(' '); end if;
                   if to_number(pa60(16).output)  >= to_number(pa_stet(i).output) then pa60(i) := ty_obj(v_val); else pa60(i) := ty_obj(' '); end if;
                   if to_number(pa61(16).output)  >= to_number(pa_stet(i).output) then pa61(i) := ty_obj(v_val); else pa61(i) := ty_obj(' '); end if;
                   if to_number(pa62(16).output)  >= to_number(pa_stet(i).output) then pa62(i) := ty_obj(v_val); else pa62(i) := ty_obj(' '); end if;
                   if to_number(pa63(16).output)  >= to_number(pa_stet(i).output) then pa63(i) := ty_obj(v_val); else pa63(i) := ty_obj(' '); end if;
                   if to_number(pa64(16).output)  >= to_number(pa_stet(i).output) then pa64(i) := ty_obj(v_val); else pa64(i) := ty_obj(' '); end if;
                   if to_number(pa65(16).output)  >= to_number(pa_stet(i).output) then pa65(i) := ty_obj(v_val); else pa65(i) := ty_obj(' '); end if;
                   if to_number(pa66(16).output)  >= to_number(pa_stet(i).output) then pa66(i) := ty_obj(v_val); else pa66(i) := ty_obj(' '); end if;
                   if to_number(pa67(16).output)  >= to_number(pa_stet(i).output) then pa67(i) := ty_obj(v_val); else pa67(i) := ty_obj(' '); end if;
                   if to_number(pa68(16).output)  >= to_number(pa_stet(i).output) then pa68(i) := ty_obj(v_val); else pa68(i) := ty_obj(' '); end if;
                   if to_number(pa69(16).output)  >= to_number(pa_stet(i).output) then pa69(i) := ty_obj(v_val); else pa69(i) := ty_obj(' '); end if;
                   if to_number(pa70(16).output)  >= to_number(pa_stet(i).output) then pa70(i) := ty_obj(v_val); else pa70(i) := ty_obj(' '); end if;
                   if to_number(pa71(16).output)  >= to_number(pa_stet(i).output) then pa71(i) := ty_obj(v_val); else pa71(i) := ty_obj(' '); end if;
                   if to_number(pa72(16).output)  >= to_number(pa_stet(i).output) then pa72(i) := ty_obj(v_val); else pa72(i) := ty_obj(' '); end if;
                   if to_number(pa73(16).output)  >= to_number(pa_stet(i).output) then pa73(i) := ty_obj(v_val); else pa73(i) := ty_obj(' '); end if;
                   if to_number(pa74(16).output)  >= to_number(pa_stet(i).output) then pa74(i) := ty_obj(v_val); else pa74(i) := ty_obj(' '); end if;
                   if to_number(pa75(16).output)  >= to_number(pa_stet(i).output) then pa75(i) := ty_obj(v_val); else pa75(i) := ty_obj(' '); end if;
                   if to_number(pa76(16).output)  >= to_number(pa_stet(i).output) then pa76(i) := ty_obj(v_val); else pa76(i) := ty_obj(' '); end if;
                   if to_number(pa77(16).output)  >= to_number(pa_stet(i).output) then pa77(i) := ty_obj(v_val); else pa77(i) := ty_obj(' '); end if;
                   if to_number(pa78(16).output)  >= to_number(pa_stet(i).output) then pa78(i) := ty_obj(v_val); else pa78(i) := ty_obj(' '); end if;
                   if to_number(pa79(16).output)  >= to_number(pa_stet(i).output) then pa79(i) := ty_obj(v_val); else pa79(i) := ty_obj(' '); end if;
                   if to_number(pa80(16).output)  >= to_number(pa_stet(i).output) then pa80(i) := ty_obj(v_val); else pa80(i) := ty_obj(' '); end if;
              end loop;
...
exception
when others then
raise_application_Error(-20001,'STACTSESSAR : '||sqlerrm );
end;
-------------------/
...
fv_ta_obj(14) :=ty_obj(rpad(substr(pv_tmp_gcinfo(12).output,1,77),77,' ')||'  '||lpad(pa_stet(3).output,6,' ') ||' |'||(
...
fv_ta_obj(15) :=ty_obj(rpad(substr(pv_tmp_gcinfo(13).output,1,77),77,' ')||'  '||lpad(pa_stet(2).output,6,' ') ||' |'||(
...
fv_ta_obj(16) :=ty_obj(rpad(substr(pv_tmp_gcinfo(14).output,1,77),77,' ')||'  '||lpad(pa_stet(1).output,6,' ') ||' |'||(
...
fv_ta_obj(17) :=ty_obj(rpad(' ',71,' ')||'        '||lpad(0,6,' ')||' +'||rpad('-',84,'-')||'+ 0');
...
for i in (      select (select  to_char(to_date(round(max(elapsed_time)/1000000),'sssss'),'hh24:mi:ss') from table(pv_only_gsqlm) gsq1 where gsq1.sql_id = gsm.sql_id) maxduration,
...
fv_ta_obj(fv_ta_obj.count) := ty_obj('| '||i.sql_id||' | '||rpad(nvl(i.sql_text,' '),83,' ')||' | '||lpad(nvl(i.maxduration,' '),9,' ')||' |    '|| rpad(i.acrossins,4,' ')||' |  '||lpad(i.exccount,2,' ')||' | '||i.db_time );
