...
REM
REM $Header: 224270.1 tacobj.sql 11.4.5.7 2013/04/05 carlos.sierra $
REM
...
CREATE TABLE &&tool_repository_schema..trca$_tool_execution (
  ...
  directory_alias             VARCHAR2(30),            -- fk dba_directories.directory_name
...
CREATE TABLE &&tool_repository_schema..trca$_trace (
  ...
  status                     VARCHAR2(30),            -- PARSING/COMPLETED/ERROR
  parse_start                DATE,
  parse_end                  DATE,
