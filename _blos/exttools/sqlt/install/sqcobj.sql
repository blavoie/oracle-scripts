...
REM
REM $Header: 215187.1 sqcobj.sql 12.1.05 2013/12/11 carlos.sierra mauro.pagano $
REM
...
ALTER TABLE &&tool_repository_schema..sqli$_file ADD (username      VARCHAR2(30));
...
ALTER TABLE &&tool_repository_schema..sqlt$_sql_statement ADD (siebel_schema                  VARCHAR2(30));
ALTER TABLE &&tool_repository_schema..sqlt$_sql_statement ADD (siebel_app_ver                 VARCHAR2(30));
ALTER TABLE &&tool_repository_schema..sqlt$_sql_statement ADD (psft                           VARCHAR2(3));
ALTER TABLE &&tool_repository_schema..sqlt$_sql_statement ADD (psft_schema                    VARCHAR2(30));
ALTER TABLE &&tool_repository_schema..sqlt$_sql_statement ADD (psft_tools_rel                 VARCHAR2(30));
...
ALTER TABLE &&tool_repository_schema..sqlt$_sql_statement ADD (username                       VARCHAR2(30));
...
ALTER TABLE &&tool_repository_schema..sqlt$_sql_plan_table ADD (object_owner             VARCHAR2(30));
ALTER TABLE &&tool_repository_schema..sqlt$_sql_plan_table ADD (object_name              VARCHAR2(30));
...
ALTER TABLE &&tool_repository_schema..sqlt$_sql_plan_table ADD (qblock_name              VARCHAR2(30));
...
ALTER TABLE &&tool_repository_schema..sqlt$_gv$sqlarea ADD (parsing_schema_name            VARCHAR2(30));
...
ALTER TABLE &&tool_repository_schema..sqlt$_gv$sqlarea ADD (sql_patch                      VARCHAR2(30));
ALTER TABLE &&tool_repository_schema..sqlt$_gv$sqlarea ADD (sql_plan_baseline              VARCHAR2(30));
...
ALTER TABLE &&tool_repository_schema..sqlt$_gv$sqlarea_plan_hash ADD (parsing_schema_name            VARCHAR2(30));
...
ALTER TABLE &&tool_repository_schema..sqlt$_gv$sql ADD (parsing_schema_name            VARCHAR2(30));
...
ALTER TABLE &&tool_repository_schema..sqlt$_gv$sql ADD (sql_patch                      VARCHAR2(30));
ALTER TABLE &&tool_repository_schema..sqlt$_gv$sql ADD (sql_plan_baseline              VARCHAR2(30));
...
ALTER TABLE &&tool_repository_schema..sqlt$_gv$sql_plan ADD (object_owner          VARCHAR2(30));
ALTER TABLE &&tool_repository_schema..sqlt$_gv$sql_plan ADD (object_name           VARCHAR2(30));
...
ALTER TABLE &&tool_repository_schema..sqlt$_gv$sql_plan ADD (qblock_name           VARCHAR2(30));
...
ALTER TABLE &&tool_repository_schema..sqlt$_gv$sql_bind_capture ADD (name              VARCHAR2(30));
...
ALTER TABLE &&tool_repository_schema..sqlg$_sql_shared_cursor_n ADD (column_name     VARCHAR2(30));
...
ALTER TABLE &&tool_repository_schema..sqlt$_nls_database_parameters ADD (parameter VARCHAR2(30));
ALTER TABLE &&tool_repository_schema..sqlt$_nls_database_parameters ADD (value     VARCHAR2(40));
...
ALTER TABLE &&tool_repository_schema..sqlt$_gv$sql_monitor ADD (username                  VARCHAR2(30));
...
ALTER TABLE &&tool_repository_schema..sqlt$_gv$sql_plan_monitor ADD (plan_object_owner       VARCHAR2(30));
ALTER TABLE &&tool_repository_schema..sqlt$_gv$sql_plan_monitor ADD (plan_object_name        VARCHAR2(30));
...
CREATE TABLE &&tool_repository_schema..sqlt$_dba_hist_active_sess_his (
statement_id NUMBER NOT NULL,
statid VARCHAR2(30) NOT NULL
);
...
ALTER TABLE &&tool_repository_schema..sqlt$_dba_hist_seg_stat_obj ADD (owner           VARCHAR2(30));
ALTER TABLE &&tool_repository_schema..sqlt$_dba_hist_seg_stat_obj ADD (object_name     VARCHAR2(30));
ALTER TABLE &&tool_repository_schema..sqlt$_dba_hist_seg_stat_obj ADD (subobject_name  VARCHAR2(30));
ALTER TABLE &&tool_repository_schema..sqlt$_dba_hist_seg_stat_obj ADD (object_type     VARCHAR2(18));
ALTER TABLE &&tool_repository_schema..sqlt$_dba_hist_seg_stat_obj ADD (tablespace_name VARCHAR2(30));
...
ALTER TABLE &&tool_repository_schema..sqlt$_dba_hist_sqlstat ADD (parsing_schema_name            VARCHAR2(30));
...
ALTER TABLE &&tool_repository_schema..sqlt$_dba_hist_sql_plan ADD (object_owner      VARCHAR2(30));
ALTER TABLE &&tool_repository_schema..sqlt$_dba_hist_sql_plan ADD (object_name       VARCHAR2(31));
...
ALTER TABLE &&tool_repository_schema..sqlt$_dba_hist_sql_plan ADD (qblock_name       VARCHAR2(31));
...
ALTER TABLE &&tool_repository_schema..sqlt$_dba_hist_sqlbind ADD (name              VARCHAR2(30));
...
ALTER TABLE &&tool_repository_schema..sqlt$_dba_dependencies ADD (owner                VARCHAR2(30));
ALTER TABLE &&tool_repository_schema..sqlt$_dba_dependencies ADD (name                 VARCHAR2(30));
ALTER TABLE &&tool_repository_schema..sqlt$_dba_dependencies ADD (type                 VARCHAR2(18));
ALTER TABLE &&tool_repository_schema..sqlt$_dba_dependencies ADD (referenced_owner     VARCHAR2(30));
ALTER TABLE &&tool_repository_schema..sqlt$_dba_dependencies ADD (referenced_name      VARCHAR2(64));
ALTER TABLE &&tool_repository_schema..sqlt$_dba_dependencies ADD (referenced_type      VARCHAR2(18));
ALTER TABLE &&tool_repository_schema..sqlt$_dba_dependencies ADD (referenced_link_name VARCHAR2(128));
...
ALTER TABLE &&tool_repository_schema..sqlt$_dba_tables ADD (owner                      VARCHAR2(30));
ALTER TABLE &&tool_repository_schema..sqlt$_dba_tables ADD (table_name                 VARCHAR2(30));
ALTER TABLE &&tool_repository_schema..sqlt$_dba_tables ADD (tablespace_name            VARCHAR2(30));
ALTER TABLE &&tool_repository_schema..sqlt$_dba_tables ADD (cluster_name               VARCHAR2(30));
ALTER TABLE &&tool_repository_schema..sqlt$_dba_tables ADD (iot_name                   VARCHAR2(30));
...
ALTER TABLE &&tool_repository_schema..sqlt$_dba_tables ADD (cluster_owner              VARCHAR2(30));
...
ALTER TABLE &&tool_repository_schema..sqlt$_dba_nested_tables ADD (owner                 VARCHAR2(30));
ALTER TABLE &&tool_repository_schema..sqlt$_dba_nested_tables ADD (table_name            VARCHAR2(30));
ALTER TABLE &&tool_repository_schema..sqlt$_dba_nested_tables ADD (table_type_owner      VARCHAR2(30));
ALTER TABLE &&tool_repository_schema..sqlt$_dba_nested_tables ADD (table_type_name       VARCHAR2(30));
ALTER TABLE &&tool_repository_schema..sqlt$_dba_nested_tables ADD (parent_table_name     VARCHAR2(30));
ALTER TABLE &&tool_repository_schema..sqlt$_dba_nested_tables ADD (parent_table_column   VARCHAR2(4000));
ALTER TABLE &&tool_repository_schema..sqlt$_dba_nested_tables ADD (storage_spec          VARCHAR2(30));
...
ALTER TABLE &&tool_repository_schema..sqlt$_dba_object_tables ADD (owner                     VARCHAR2(30));
ALTER TABLE &&tool_repository_schema..sqlt$_dba_object_tables ADD (table_name                VARCHAR2(30));
ALTER TABLE &&tool_repository_schema..sqlt$_dba_object_tables ADD (tablespace_name           VARCHAR2(30));
ALTER TABLE &&tool_repository_schema..sqlt$_dba_object_tables ADD (cluster_name              VARCHAR2(30));
ALTER TABLE &&tool_repository_schema..sqlt$_dba_object_tables ADD (iot_name                  VARCHAR2(30));
...
ALTER TABLE &&tool_repository_schema..sqlt$_dba_object_tables ADD (table_type_owner          VARCHAR2(30));
ALTER TABLE &&tool_repository_schema..sqlt$_dba_object_tables ADD (table_type                VARCHAR2(30));
...
ALTER TABLE &&tool_repository_schema..sqlt$_dba_object_tables ADD (cluster_owner             VARCHAR2(30));
...
ALTER TABLE &&tool_repository_schema..sqlt$_dba_tab_statistics ADD (owner                     VARCHAR2(30));
ALTER TABLE &&tool_repository_schema..sqlt$_dba_tab_statistics ADD (table_name                VARCHAR2(30));
ALTER TABLE &&tool_repository_schema..sqlt$_dba_tab_statistics ADD (partition_name            VARCHAR2(30));
ALTER TABLE &&tool_repository_schema..sqlt$_dba_tab_statistics ADD (partition_position        NUMBER);
ALTER TABLE &&tool_repository_schema..sqlt$_dba_tab_statistics ADD (subpartition_name         VARCHAR2(30));
...
ALTER TABLE &&tool_repository_schema..sqlt$_dba_stat_extensions ADD (owner          VARCHAR2(30));
ALTER TABLE &&tool_repository_schema..sqlt$_dba_stat_extensions ADD (table_name     VARCHAR2(30));
ALTER TABLE &&tool_repository_schema..sqlt$_dba_stat_extensions ADD (extension_name VARCHAR2(30));
...
ALTER TABLE &&tool_repository_schema..sqlt$_dba_tab_modifications ADD (table_owner       VARCHAR2(30));
ALTER TABLE &&tool_repository_schema..sqlt$_dba_tab_modifications ADD (table_name        VARCHAR2(30));
ALTER TABLE &&tool_repository_schema..sqlt$_dba_tab_modifications ADD (partition_name    VARCHAR2(30));
ALTER TABLE &&tool_repository_schema..sqlt$_dba_tab_modifications ADD (subpartition_name VARCHAR2(30));
...
ALTER TABLE &&tool_repository_schema..sqlt$_dba_tab_cols ADD (owner                VARCHAR2(30));
ALTER TABLE &&tool_repository_schema..sqlt$_dba_tab_cols ADD (table_name           VARCHAR2(30));
ALTER TABLE &&tool_repository_schema..sqlt$_dba_tab_cols ADD (column_name          VARCHAR2(30));
...
ALTER TABLE &&tool_repository_schema..sqlt$_dba_tab_cols ADD (data_type_owner      VARCHAR2(30));
...
ALTER TABLE &&tool_repository_schema..sqlt$_dba_nested_table_cols ADD (owner                VARCHAR2(30));
ALTER TABLE &&tool_repository_schema..sqlt$_dba_nested_table_cols ADD (table_name           VARCHAR2(30));
ALTER TABLE &&tool_repository_schema..sqlt$_dba_nested_table_cols ADD (column_name          VARCHAR2(30));
...
ALTER TABLE &&tool_repository_schema..sqlt$_dba_nested_table_cols ADD (data_type_owner      VARCHAR2(30));
...
ALTER TABLE &&tool_repository_schema..sqlt$_dba_tab_col_statistics ADD (owner         VARCHAR2(30));
ALTER TABLE &&tool_repository_schema..sqlt$_dba_tab_col_statistics ADD (table_name    VARCHAR2(30));
ALTER TABLE &&tool_repository_schema..sqlt$_dba_tab_col_statistics ADD (column_name   VARCHAR2(30));
...
ALTER TABLE &&tool_repository_schema..sqlt$_dba_indexes ADD (owner                     VARCHAR2(30));
ALTER TABLE &&tool_repository_schema..sqlt$_dba_indexes ADD (index_name                VARCHAR2(30));
ALTER TABLE &&tool_repository_schema..sqlt$_dba_indexes ADD (index_type                VARCHAR2(27));
ALTER TABLE &&tool_repository_schema..sqlt$_dba_indexes ADD (table_owner               VARCHAR2(30));
ALTER TABLE &&tool_repository_schema..sqlt$_dba_indexes ADD (table_name                VARCHAR2(30));
...
ALTER TABLE &&tool_repository_schema..sqlt$_dba_indexes ADD (tablespace_name           VARCHAR2(30));
...
ALTER TABLE &&tool_repository_schema..sqlt$_dba_indexes ADD (ityp_owner                VARCHAR2(30));
ALTER TABLE &&tool_repository_schema..sqlt$_dba_indexes ADD (ityp_name                 VARCHAR2(30));
...
ALTER TABLE &&tool_repository_schema..sqlt$_dba_ind_statistics ADD (owner                   VARCHAR2(30));
ALTER TABLE &&tool_repository_schema..sqlt$_dba_ind_statistics ADD (index_name              VARCHAR2(30));
ALTER TABLE &&tool_repository_schema..sqlt$_dba_ind_statistics ADD (table_owner             VARCHAR2(30));
ALTER TABLE &&tool_repository_schema..sqlt$_dba_ind_statistics ADD (table_name              VARCHAR2(30));
ALTER TABLE &&tool_repository_schema..sqlt$_dba_ind_statistics ADD (partition_name          VARCHAR2(30));
ALTER TABLE &&tool_repository_schema..sqlt$_dba_ind_statistics ADD (partition_position      NUMBER);
ALTER TABLE &&tool_repository_schema..sqlt$_dba_ind_statistics ADD (subpartition_name       VARCHAR2(30));
...
ALTER TABLE &&tool_repository_schema..sqlt$_dba_ind_columns ADD (index_owner     VARCHAR2(30));
ALTER TABLE &&tool_repository_schema..sqlt$_dba_ind_columns ADD (index_name      VARCHAR2(30));
ALTER TABLE &&tool_repository_schema..sqlt$_dba_ind_columns ADD (table_owner     VARCHAR2(30));
ALTER TABLE &&tool_repository_schema..sqlt$_dba_ind_columns ADD (table_name      VARCHAR2(30));
...
ALTER TABLE &&tool_repository_schema..sqlt$_dba_ind_expressions ADD (index_owner       VARCHAR2(30));
ALTER TABLE &&tool_repository_schema..sqlt$_dba_ind_expressions ADD (index_name        VARCHAR2(30));
ALTER TABLE &&tool_repository_schema..sqlt$_dba_ind_expressions ADD (table_owner       VARCHAR2(30));
ALTER TABLE &&tool_repository_schema..sqlt$_dba_ind_expressions ADD (table_name        VARCHAR2(30));
...
ALTER TABLE &&tool_repository_schema..sqlt$_dba_tab_histograms ADD (owner                    VARCHAR2(30));
ALTER TABLE &&tool_repository_schema..sqlt$_dba_tab_histograms ADD (table_name               VARCHAR2(30));
...
ALTER TABLE &&tool_repository_schema..sqlt$_dba_part_key_columns ADD (owner           VARCHAR2(30));
ALTER TABLE &&tool_repository_schema..sqlt$_dba_part_key_columns ADD (name            VARCHAR2(30));
...
ALTER TABLE &&tool_repository_schema..sqlt$_dba_tab_partitions ADD (table_owner            VARCHAR2(30));
ALTER TABLE &&tool_repository_schema..sqlt$_dba_tab_partitions ADD (table_name             VARCHAR2(30));
ALTER TABLE &&tool_repository_schema..sqlt$_dba_tab_partitions ADD (composite              VARCHAR2(3));
ALTER TABLE &&tool_repository_schema..sqlt$_dba_tab_partitions ADD (partition_name         VARCHAR2(30));
...
ALTER TABLE &&tool_repository_schema..sqlt$_dba_tab_partitions ADD (tablespace_name        VARCHAR2(30));
...
ALTER TABLE &&tool_repository_schema..sqlt$_dba_tab_partitions ADD (parent_table_partition VARCHAR2(30));
...
ALTER TABLE &&tool_repository_schema..sqlt$_dba_ind_partitions ADD (index_owner             VARCHAR2(30));
ALTER TABLE &&tool_repository_schema..sqlt$_dba_ind_partitions ADD (index_name              VARCHAR2(30));
ALTER TABLE &&tool_repository_schema..sqlt$_dba_ind_partitions ADD (composite               VARCHAR2(3));
ALTER TABLE &&tool_repository_schema..sqlt$_dba_ind_partitions ADD (partition_name          VARCHAR2(30));
...
ALTER TABLE &&tool_repository_schema..sqlt$_dba_ind_partitions ADD (tablespace_name         VARCHAR2(30));
...
ALTER TABLE &&tool_repository_schema..sqlt$_dba_part_col_statistics ADD (owner              VARCHAR2(30));
ALTER TABLE &&tool_repository_schema..sqlt$_dba_part_col_statistics ADD (table_name         VARCHAR2(30));
ALTER TABLE &&tool_repository_schema..sqlt$_dba_part_col_statistics ADD (partition_name     VARCHAR2(30));
...
ALTER TABLE &&tool_repository_schema..sqlt$_dba_part_histograms ADD (owner                    VARCHAR2(30));
ALTER TABLE &&tool_repository_schema..sqlt$_dba_part_histograms ADD (table_name               VARCHAR2(30));
ALTER TABLE &&tool_repository_schema..sqlt$_dba_part_histograms ADD (partition_name           VARCHAR2(30));
...
ALTER TABLE &&tool_repository_schema..sqlt$_dba_tab_subpartitions ADD (table_owner           VARCHAR2(30));
ALTER TABLE &&tool_repository_schema..sqlt$_dba_tab_subpartitions ADD (table_name            VARCHAR2(30));
ALTER TABLE &&tool_repository_schema..sqlt$_dba_tab_subpartitions ADD (partition_name        VARCHAR2(30));
ALTER TABLE &&tool_repository_schema..sqlt$_dba_tab_subpartitions ADD (subpartition_name     VARCHAR2(30));
...
ALTER TABLE &&tool_repository_schema..sqlt$_dba_tab_subpartitions ADD (tablespace_name       VARCHAR2(30));
...
ALTER TABLE &&tool_repository_schema..sqlt$_dba_ind_subpartitions ADD (index_owner             VARCHAR2(30));
ALTER TABLE &&tool_repository_schema..sqlt$_dba_ind_subpartitions ADD (index_name              VARCHAR2(30));
ALTER TABLE &&tool_repository_schema..sqlt$_dba_ind_subpartitions ADD (partition_name          VARCHAR2(30));
ALTER TABLE &&tool_repository_schema..sqlt$_dba_ind_subpartitions ADD (subpartition_name       VARCHAR2(30));
...
ALTER TABLE &&tool_repository_schema..sqlt$_dba_ind_subpartitions ADD (tablespace_name         VARCHAR2(30));
...
ALTER TABLE &&tool_repository_schema..sqlt$_dba_subpart_col_stats ADD (owner              VARCHAR2(30));
ALTER TABLE &&tool_repository_schema..sqlt$_dba_subpart_col_stats ADD (table_name         VARCHAR2(30));
ALTER TABLE &&tool_repository_schema..sqlt$_dba_subpart_col_stats ADD (subpartition_name  VARCHAR2(30));
...
ALTER TABLE &&tool_repository_schema..sqlt$_dba_subpart_histograms ADD (owner                    VARCHAR2(30));
ALTER TABLE &&tool_repository_schema..sqlt$_dba_subpart_histograms ADD (table_name               VARCHAR2(30));
ALTER TABLE &&tool_repository_schema..sqlt$_dba_subpart_histograms ADD (subpartition_name        VARCHAR2(30));
...
ALTER TABLE &&tool_repository_schema..sqlt$_dba_constraints ADD (owner             VARCHAR2(30));
ALTER TABLE &&tool_repository_schema..sqlt$_dba_constraints ADD (constraint_name   VARCHAR2(30));
ALTER TABLE &&tool_repository_schema..sqlt$_dba_constraints ADD (constraint_type   VARCHAR2(1));
ALTER TABLE &&tool_repository_schema..sqlt$_dba_constraints ADD (table_name        VARCHAR2(30));
ALTER TABLE &&tool_repository_schema..sqlt$_dba_constraints ADD (search_condition  CLOB);
ALTER TABLE &&tool_repository_schema..sqlt$_dba_constraints ADD (r_owner           VARCHAR2(30));
ALTER TABLE &&tool_repository_schema..sqlt$_dba_constraints ADD (r_constraint_name VARCHAR2(30));
...
ALTER TABLE &&tool_repository_schema..sqlt$_dba_constraints ADD (index_owner       VARCHAR2(30));
ALTER TABLE &&tool_repository_schema..sqlt$_dba_constraints ADD (index_name        VARCHAR2(30));
...
ALTER TABLE &&tool_repository_schema..sqlt$_dba_segments ADD (owner            VARCHAR2(30));
ALTER TABLE &&tool_repository_schema..sqlt$_dba_segments ADD (segment_name     VARCHAR2(81));
ALTER TABLE &&tool_repository_schema..sqlt$_dba_segments ADD (partition_name   VARCHAR2(30));
...
ALTER TABLE &&tool_repository_schema..sqlt$_dba_segments ADD (tablespace_name  VARCHAR2(30));
...
ALTER TABLE &&tool_repository_schema..sqlt$_dba_tablespaces ADD (tablespace_name          VARCHAR2(30));
...
ALTER TABLE &&tool_repository_schema..sqlt$_dba_objects ADD (owner          VARCHAR2(30));
ALTER TABLE &&tool_repository_schema..sqlt$_dba_objects ADD (object_name    VARCHAR2(128));
ALTER TABLE &&tool_repository_schema..sqlt$_dba_objects ADD (subobject_name VARCHAR2(30));
...
ALTER TABLE &&tool_repository_schema..sqlt$_dba_objects ADD (edition_name   VARCHAR2(30));
-- extension
...
ALTER TABLE &&tool_repository_schema..sqlt$_dba_source ADD (owner VARCHAR2(30));
ALTER TABLE &&tool_repository_schema..sqlt$_dba_source ADD (name  VARCHAR2(30));
...
ALTER TABLE &&tool_repository_schema..sqlt$_dba_scheduler_jobs ADD (owner                         VARCHAR2(30));
ALTER TABLE &&tool_repository_schema..sqlt$_dba_scheduler_jobs ADD (job_name                      VARCHAR2(30));
ALTER TABLE &&tool_repository_schema..sqlt$_dba_scheduler_jobs ADD (job_subname                   VARCHAR2(30));
ALTER TABLE &&tool_repository_schema..sqlt$_dba_scheduler_jobs ADD (job_style                     VARCHAR2(11));
ALTER TABLE &&tool_repository_schema..sqlt$_dba_scheduler_jobs ADD (job_creator                   VARCHAR2(30));
...
ALTER TABLE &&tool_repository_schema..sqlt$_dba_scheduler_jobs ADD (event_queue_owner             VARCHAR2(30));
ALTER TABLE &&tool_repository_schema..sqlt$_dba_scheduler_jobs ADD (event_queue_name              VARCHAR2(30));
...
ALTER TABLE &&tool_repository_schema..sqlt$_dba_scheduler_jobs ADD (job_class                     VARCHAR2(30));
...
ALTER TABLE &&tool_repository_schema..sqlt$_dba_scheduler_jobs ADD (credential_owner              VARCHAR2(30));
ALTER TABLE &&tool_repository_schema..sqlt$_dba_scheduler_jobs ADD (credential_name               VARCHAR2(30));
...
ALTER TABLE &&tool_repository_schema..sqlt$_dba_autotask_client ADD (consumer_group               VARCHAR2(30));
...
ALTER TABLE &&tool_repository_schema..sqlt$_dba_col_usage$ ADD (owner             VARCHAR2(30));
ALTER TABLE &&tool_repository_schema..sqlt$_dba_col_usage$ ADD (table_name        VARCHAR2(30));
ALTER TABLE &&tool_repository_schema..sqlt$_dba_col_usage$ ADD (column_name       VARCHAR2(30));
...
ALTER TABLE &&tool_repository_schema..sqlt$_gv$vpd_policy ADD (object_owner          VARCHAR2(30));
ALTER TABLE &&tool_repository_schema..sqlt$_gv$vpd_policy ADD (object_name           VARCHAR2(30));
ALTER TABLE &&tool_repository_schema..sqlt$_gv$vpd_policy ADD (policy_group          VARCHAR2(30));
ALTER TABLE &&tool_repository_schema..sqlt$_gv$vpd_policy ADD (policy                VARCHAR2(30));
ALTER TABLE &&tool_repository_schema..sqlt$_gv$vpd_policy ADD (policy_function_owner VARCHAR2(30));
...
ALTER TABLE &&tool_repository_schema..sqlt$_dba_policies ADD (object_owner   VARCHAR2(30));
ALTER TABLE &&tool_repository_schema..sqlt$_dba_policies ADD (object_name    VARCHAR2(30));
ALTER TABLE &&tool_repository_schema..sqlt$_dba_policies ADD (policy_group   VARCHAR2(30));
ALTER TABLE &&tool_repository_schema..sqlt$_dba_policies ADD (policy_name    VARCHAR2(30));
ALTER TABLE &&tool_repository_schema..sqlt$_dba_policies ADD (pf_owner       VARCHAR2(30));
ALTER TABLE &&tool_repository_schema..sqlt$_dba_policies ADD (package        VARCHAR2(30));
ALTER TABLE &&tool_repository_schema..sqlt$_dba_policies ADD (function       VARCHAR2(30));
...
ALTER TABLE &&tool_repository_schema..sqlt$_dba_audit_policies ADD (object_schema         VARCHAR2(30));
ALTER TABLE &&tool_repository_schema..sqlt$_dba_audit_policies ADD (object_name           VARCHAR2(30));
ALTER TABLE &&tool_repository_schema..sqlt$_dba_audit_policies ADD (policy_owner          VARCHAR2(30));
ALTER TABLE &&tool_repository_schema..sqlt$_dba_audit_policies ADD (policy_name           VARCHAR2(30));
ALTER TABLE &&tool_repository_schema..sqlt$_dba_audit_policies ADD (policy_text           VARCHAR2(4000));
ALTER TABLE &&tool_repository_schema..sqlt$_dba_audit_policies ADD (policy_column         VARCHAR2(30));
ALTER TABLE &&tool_repository_schema..sqlt$_dba_audit_policies ADD (pf_schema             VARCHAR2(30));
ALTER TABLE &&tool_repository_schema..sqlt$_dba_audit_policies ADD (pf_package            VARCHAR2(30));
ALTER TABLE &&tool_repository_schema..sqlt$_dba_audit_policies ADD (pf_function           VARCHAR2(30));
...
ALTER TABLE &&tool_repository_schema..sqlt$_optstat_user_prefs$ ADD (pname   VARCHAR2(30));
...
ALTER TABLE &&tool_repository_schema..sqlt$_dba_tab_stats_versions ADD (owner             VARCHAR2(30));
ALTER TABLE &&tool_repository_schema..sqlt$_dba_tab_stats_versions ADD (table_name        VARCHAR2(30));
ALTER TABLE &&tool_repository_schema..sqlt$_dba_tab_stats_versions ADD (partition_name    VARCHAR2(30));
ALTER TABLE &&tool_repository_schema..sqlt$_dba_tab_stats_versions ADD (subpartition_name VARCHAR2(30));
...
ALTER TABLE &&tool_repository_schema..sqlt$_dba_ind_stats_versions ADD (owner                   VARCHAR2(30));
ALTER TABLE &&tool_repository_schema..sqlt$_dba_ind_stats_versions ADD (index_name              VARCHAR2(30));
ALTER TABLE &&tool_repository_schema..sqlt$_dba_ind_stats_versions ADD (table_owner             VARCHAR2(30));
ALTER TABLE &&tool_repository_schema..sqlt$_dba_ind_stats_versions ADD (table_name              VARCHAR2(30));
ALTER TABLE &&tool_repository_schema..sqlt$_dba_ind_stats_versions ADD (partition_name          VARCHAR2(30));
ALTER TABLE &&tool_repository_schema..sqlt$_dba_ind_stats_versions ADD (subpartition_name       VARCHAR2(30));
...
ALTER TABLE &&tool_repository_schema..sqlt$_dba_col_stats_versions ADD (owner             VARCHAR2(30));
ALTER TABLE &&tool_repository_schema..sqlt$_dba_col_stats_versions ADD (table_name        VARCHAR2(30));
ALTER TABLE &&tool_repository_schema..sqlt$_dba_col_stats_versions ADD (partition_name    VARCHAR2(30));
ALTER TABLE &&tool_repository_schema..sqlt$_dba_col_stats_versions ADD (subpartition_name VARCHAR2(30));
...
ALTER TABLE &&tool_repository_schema..sqlt$_dba_col_stats_versions ADD (column_name       VARCHAR2(30));
...
ALTER TABLE &&tool_repository_schema..sqlt$_dba_col_stats_versions ADD (colname           VARCHAR2(30));
...
ALTER TABLE &&tool_repository_schema..sqlt$_dba_histgrm_stats_versn ADD (owner                 VARCHAR2(30));
ALTER TABLE &&tool_repository_schema..sqlt$_dba_histgrm_stats_versn ADD (table_name            VARCHAR2(30));
ALTER TABLE &&tool_repository_schema..sqlt$_dba_histgrm_stats_versn ADD (partition_name        VARCHAR2(30));
ALTER TABLE &&tool_repository_schema..sqlt$_dba_histgrm_stats_versn ADD (subpartition_name     VARCHAR2(30));
...
ALTER TABLE &&tool_repository_schema..sqlt$_dba_histgrm_stats_versn ADD (column_name           VARCHAR2(30));
...
ALTER TABLE &&tool_repository_schema..sqlt$_dba_histgrm_stats_versn ADD (colname               VARCHAR2(30));
...
ALTER TABLE &&tool_repository_schema..sqlt$_aux_stats$ ADD (sname       VARCHAR2(30));
ALTER TABLE &&tool_repository_schema..sqlt$_aux_stats$ ADD (pname       VARCHAR2(30));
...
ALTER TABLE &&tool_repository_schema..sqlt$_wri$_optstat_aux_history ADD (sname   VARCHAR2(30));
ALTER TABLE &&tool_repository_schema..sqlt$_wri$_optstat_aux_history ADD (pname   VARCHAR2(30));
...
ALTER TABLE &&tool_repository_schema..sqlt$_gv$segment_statistics ADD (owner           VARCHAR2(30));
ALTER TABLE &&tool_repository_schema..sqlt$_gv$segment_statistics ADD (object_name     VARCHAR2(30));
ALTER TABLE &&tool_repository_schema..sqlt$_gv$segment_statistics ADD (subobject_name  VARCHAR2(30));
ALTER TABLE &&tool_repository_schema..sqlt$_gv$segment_statistics ADD (tablespace_name VARCHAR2(30));
...
ALTER TABLE &&tool_repository_schema..sqlt$_gv$pq_sysstat ADD (statistic      VARCHAR2(30));
...
ALTER TABLE &&tool_repository_schema..sqlt$_gv$px_process_sysstat ADD (statistic      VARCHAR2(30));
...
ALTER TABLE &&tool_repository_schema..sqlt$_gv$pq_sesstat ADD (statistic      VARCHAR2(30));
...
ALTER TABLE &&tool_repository_schema..sqlt$_dbms_xplan ADD (format            CHAR(1));
ALTER TABLE &&tool_repository_schema..sqlt$_dbms_xplan ADD (plan_hash_value   NUMBER);
ALTER TABLE &&tool_repository_schema..sqlt$_dbms_xplan ADD (sql_handle        VARCHAR2(30));
ALTER TABLE &&tool_repository_schema..sqlt$_dbms_xplan ADD (plan_name         VARCHAR2(30));
...
ALTER TABLE &&tool_repository_schema..sqlt$_wri$_adv_tasks ADD (owner_name          VARCHAR2(30));
ALTER TABLE &&tool_repository_schema..sqlt$_wri$_adv_tasks ADD (name                VARCHAR2(30));
...
ALTER TABLE &&tool_repository_schema..sqlt$_wri$_adv_tasks ADD (advisor_name        VARCHAR2(30));
...
ALTER TABLE &&tool_repository_schema..sqlt$_wri$_adv_tasks ADD (last_exec_name      VARCHAR2(30));
...
ALTER TABLE &&tool_repository_schema..sqlt$_wri$_adv_tasks ADD (how_created         VARCHAR2(30));
ALTER TABLE &&tool_repository_schema..sqlt$_wri$_adv_tasks ADD (source              VARCHAR2(30));
...
ALTER TABLE &&tool_repository_schema..sqlt$_wri$_adv_rationale ADD (exec_name     VARCHAR2(30));
ALTER TABLE &&tool_repository_schema..sqlt$_wri$_adv_rationale ADD (type          VARCHAR2(30));
...
ALTER TABLE &&tool_repository_schema..sqlt$_dba_sqltune_plans ADD (execution_name    VARCHAR2(30));
...
ALTER TABLE &&tool_repository_schema..sqlt$_dba_sqltune_plans ADD (operation         VARCHAR2(30));
...
ALTER TABLE &&tool_repository_schema..sqlt$_dba_sqltune_plans ADD (object_owner      VARCHAR2(30));
ALTER TABLE &&tool_repository_schema..sqlt$_dba_sqltune_plans ADD (object_name       VARCHAR2(30));
...
ALTER TABLE &&tool_repository_schema..sqlt$_dba_sqltune_plans ADD (object_type       VARCHAR2(30));
...
ALTER TABLE &&tool_repository_schema..sqlt$_dba_sqltune_plans ADD (distribution      VARCHAR2(30));
...
ALTER TABLE &&tool_repository_schema..sqlt$_dba_sqltune_plans ADD (qblock_name       VARCHAR2(30));
...
ALTER TABLE &&tool_repository_schema..sqlt$_plan_extension ADD (source                VARCHAR2(30));
...
ALTER TABLE &&tool_repository_schema..sqlt$_plan_extension ADD (operation             VARCHAR2(30));
ALTER TABLE &&tool_repository_schema..sqlt$_plan_extension ADD (options               VARCHAR2(30));
...
ALTER TABLE &&tool_repository_schema..sqlt$_plan_extension ADD (object_owner          VARCHAR2(30));
ALTER TABLE &&tool_repository_schema..sqlt$_plan_extension ADD (object_name           VARCHAR2(30));
...
ALTER TABLE &&tool_repository_schema..sqlt$_plan_extension ADD (qblock_name           VARCHAR2(30));
...
ALTER TABLE &&tool_repository_schema..sqlt$_dba_sql_patches ADD (name           VARCHAR2(30));
ALTER TABLE &&tool_repository_schema..sqlt$_dba_sql_patches ADD (category       VARCHAR2(30));
...
ALTER TABLE &&tool_repository_schema..sqlt$_dba_sql_patches ADD (task_exec_name VARCHAR2(30));
...
ALTER TABLE &&tool_repository_schema..sqlt$_dba_sql_profiles ADD (name           VARCHAR2(30));
ALTER TABLE &&tool_repository_schema..sqlt$_dba_sql_profiles ADD (category       VARCHAR2(30));
...
ALTER TABLE &&tool_repository_schema..sqlt$_dba_sql_profiles ADD (task_exec_name VARCHAR2(30));
...
ALTER TABLE &&tool_repository_schema..sqlt$_dba_sql_plan_baselines ADD (sql_handle          VARCHAR2(30));
ALTER TABLE &&tool_repository_schema..sqlt$_dba_sql_plan_baselines ADD (sql_text            CLOB);
ALTER TABLE &&tool_repository_schema..sqlt$_dba_sql_plan_baselines ADD (plan_name           VARCHAR2(30));
ALTER TABLE &&tool_repository_schema..sqlt$_dba_sql_plan_baselines ADD (creator             VARCHAR2(30));
ALTER TABLE &&tool_repository_schema..sqlt$_dba_sql_plan_baselines ADD (origin              VARCHAR2(14));
ALTER TABLE &&tool_repository_schema..sqlt$_dba_sql_plan_baselines ADD (parsing_schema_name VARCHAR2(30));
...
ALTER TABLE &&tool_repository_schema..sqlt$_sqlobj$data ADD (category  VARCHAR2(30));
...
ALTER TABLE &&tool_repository_schema..sqlt$_sqlobj$ ADD (category      VARCHAR2(30));
...
ALTER TABLE &&tool_repository_schema..sqlt$_sqlobj$ ADD (name          VARCHAR2(30));
...
ALTER TABLE &&tool_repository_schema..sqlt$_sqlprof$attr ADD (category  VARCHAR2(30));
...
ALTER TABLE &&tool_repository_schema..sqlt$_sqlprof$ ADD (sp_name       VARCHAR2(30));
ALTER TABLE &&tool_repository_schema..sqlt$_sqlprof$ ADD (signature     NUMBER);
ALTER TABLE &&tool_repository_schema..sqlt$_sqlprof$ ADD (category      VARCHAR2(30));
...
ALTER TABLE &&tool_repository_schema..sqlt$_dba_outlines ADD (name       VARCHAR2(30));
ALTER TABLE &&tool_repository_schema..sqlt$_dba_outlines ADD (owner      VARCHAR2(30));
ALTER TABLE &&tool_repository_schema..sqlt$_dba_outlines ADD (category   VARCHAR2(30));
...
ALTER TABLE &&tool_repository_schema..sqlt$_dba_outline_hints ADD (name     VARCHAR2(30));
ALTER TABLE &&tool_repository_schema..sqlt$_dba_outline_hints ADD (owner    VARCHAR2(30));
...
ALTER TABLE &&tool_repository_schema..sqlt$_metadata ADD (owner       VARCHAR2(30));
ALTER TABLE &&tool_repository_schema..sqlt$_metadata ADD (object_name VARCHAR2(30));
ALTER TABLE &&tool_repository_schema..sqlt$_metadata ADD (object_type VARCHAR2(30));
...
ALTER TABLE &&tool_repository_schema..sqlt$_fnd_histogram_cols ADD (table_name        VARCHAR2(30));
ALTER TABLE &&tool_repository_schema..sqlt$_fnd_histogram_cols ADD (column_name       VARCHAR2(30));
ALTER TABLE &&tool_repository_schema..sqlt$_fnd_histogram_cols ADD (partition         VARCHAR2(30));
...
ALTER TABLE &&tool_repository_schema..sqlt$_fnd_histogram_cols ADD (owner             VARCHAR2(30));
...
ALTER TABLE &&tool_repository_schema..sqlt$_peeked_binds ADD (source              VARCHAR2(30));
...
ALTER TABLE &&tool_repository_schema..sqlt$_plan_info ADD (source              VARCHAR2(30));
...
-- GV$SQL_PLAN, DBA_HIST_SQL_PLAN, DBA_SQLTUNE_PLANS
ALTER TABLE &&tool_repository_schema..sqlt$_outline_data ADD (source              VARCHAR2(30));
...
ALTER TABLE &&tool_repository_schema..sqlt$_stgtab_sqlprof ADD (statid VARCHAR2(30));
