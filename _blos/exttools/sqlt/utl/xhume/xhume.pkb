...
/* $Header: xhume/xhume.pkb 11.4.4.1 2012/01/02 carlos.sierra $ */
   ...
   *
   * ------------------------- */
  TOOL_VERSION         CONSTANT VARCHAR2(32)  := '11.4.4.1';
  ...
  COPYRIGHT            CONSTANT VARCHAR2(128) := 'Copyright (c) 2000-2012, Oracle Corporation. All rights reserved.';
