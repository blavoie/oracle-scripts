...
REM $Header: 215187.1 sqlt_delete_table_hgrm.sql 11.4.5.0 2012/11/21 carlos.sierra $
REM
...
REM
REM SCRIPT
REM   sqlt/utl/xgram/sqlt_delete_table_hgrm.sql
REM
REM DESCRIPTION
REM   Deletes ALL column's CBO histograms for one table or partition
...
SPO sqlt_delete_table_hgrm_&&log_time..log
SET TERM ON;
PRO sqlt_delete_table_hgrm_&&log_time..log
PRO
...
PRO p_force        : '&&p_force.'
PRO
PRO EXEC &&tool_administer_schema..sqlt$s.delete_table_hgrm(p_ownname => '&&p_ownname.', p_tabname => '&&p_tabname.', p_partname => '&&p_partname.', p_cascade_parts => &&p_cascade_parts., p_no_invalidate => &&p_no_invalidate., p_force => &&p_force.);;
PRO
SET SERVEROUT ON SIZE 1000000;
BEGIN
  &&tool_administer_schema..sqlt$s.delete_table_hgrm (
    p_ownname       => '&&p_ownname.',
    p_tabname       => '&&p_tabname.',
...
PRO
PRO SQLT_DELETE_TABLE_HGRM completed.
SPO OFF;
