REM $Header: 215187.1 sqltcommon7.sql 11.4.5.7 2013/04/05 carlos.sierra $
-- begin common
...
SET TERM OFF;
HOS tkprof ^^udump_path.*_ora_*_S^^statement_id._SQLT_TRACE.trc ^^unique_id._sqlt_tkprof_nosort.txt
HOS tkprof ^^udump_path.*_ora_*_S^^statement_id._SQLT_TRACE.trc ^^unique_id._sqlt_tkprof_sort.txt sort=prsela exeela fchela
...
PRO ### tkprof commands below may error out with "could not open trace file". disregard error.
SET TERM OFF;
HOS tkprof ^^udump_path.S^^statement_id._SQLT_TRACE.trc ^^unique_id._sqlt_tkprof_nosort.txt
HOS tkprof ^^udump_path.S^^statement_id._SQLT_TRACE.trc ^^unique_id._sqlt_tkprof_sort.txt sort=prsela exeela fchela
...
PRO ### tkprof commands below may error out with "could not open trace file". disregard error.
SET TERM OFF;
HOS tkprof ^^traces_directory_path.*_ora_*_S^^statement_id._SQLT_TRACE.trc ^^unique_id._sqlt_tkprof_nosort.txt
HOS tkprof ^^traces_directory_path.*_ora_*_S^^statement_id._SQLT_TRACE.trc ^^unique_id._sqlt_tkprof_sort.txt sort=prsela exeela fchela
--
