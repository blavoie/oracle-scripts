...
from   bg_awr_report_text
      ,bg_report_definitions
      ,bg_reports
where  bg_awr_report_text.report_run_id = &&v_report_run_id
and    bg_awr_report_text.section       = bg_report_definitions.section_name
and    bg_report_definitions.report_id  = bg_reports.report_id
and    bg_reports.report_title = 'STANDARD AWR REPORT'
order by bg_report_definitions.section_order
        ,bg_awr_report_text.line
/
