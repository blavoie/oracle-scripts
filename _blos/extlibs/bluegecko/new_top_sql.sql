...
set heading off
ttitle off
column v_prev_report_run_id NEW_VALUE v_prev_report_run_id NOPRINT;
...
select max(report_run_id) v_prev_report_run_id 
...
TTITLE CENTER 'SQL Statements Which Are New To The Top SQL List: TOP ' v_section SKIP 2 CENTER 'Sample_start: '  v_start_dt '   --   Sample End: ' v_end_dt SKIP 2
...
and   bg_awr_report_sql_time.sql_id NOT IN (select sql_id from bg_awr_report_sql_time where report_run_id = &&v_prev_report_run_id)
