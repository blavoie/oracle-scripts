...
exec dbms_stats.gather_schema_stats(ownname => '&gss_owner', estimate_percent => dbms_stats.auto_sample_size, cascade => dbms_stats.auto_cascade, options => 'GATHER AUTO');
